# =============================================================================
# agents/cities_agent/agent.py
# =============================================================================
# 🎯 Purpose:
# This file defines a CitiesAgent that specializes in providing information about cities
...
# -----------------------------------------------------------------------------
# 🧳 CitiesAgent: AI agent that helps explore cities around the world
# -----------------------------------------------------------------------------
...
class TravelAgent(ConsulEnabledAIAgent):
    ...
    def build_agent(self) -> LlmAgent:
        """
        ⚙️ Creates and configures a Gemini agent specialized in city information.

        Returns:
            LlmAgent: A configured agent object from Google's ADK
        """
        tools = [
            FunctionTool(DestinationsTool(
